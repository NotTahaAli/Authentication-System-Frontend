...
const $$VerifyEmail = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${done ? renderTemplate`${renderComponent($$result, "NotificationLayout", $$NotificationLayout, { "title": "AuthSys | Verify Email", "link": "/login", "heading": "AuthSys", "buttonText": "Continue", "localError": localError }, { "default": ($$result2) => renderTemplate`
...
` })}` : renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "AuthSys | Verify Email", "useCaptcha": true, "heading": "AuthSys", "localError": localError }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Text", $$Text, {}, { "default": ($$result3) => renderTemplate`Please enter the email linked with your account. We will send a link to your email to verify your account.` })}${maybeRenderHead()}<form method="POST">${renderComponent($$result2, "Field", $$Field, { "id": "emailField", "type": "email", "name": "email", "placeholder": "Email", "autocomplete": "email", "required": true, "patternErrors": {
...
}, "D:/TypeScript Projects/authentication-frontend/src/pages/verify-email.astro", void 0);
const $$file = "D:/TypeScript Projects/authentication-frontend/src/pages/verify-email.astro";
